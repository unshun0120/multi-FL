...
if __name__ == "__main__":
    real_dir = "logs/2026-03-19_18-17-49/new_client_2026-03-20_10-02-34"
    synthetic_dir = "logs/2026-03-19_18-17-49/new_client_2026-03-20_16-24-14"
    
    files_to_compare = [
        os.path.join(real_dir, "fixed_entropy_mapping_real_img.csv"),
        os.path.join(real_dir, "dynamic_entropy_mapping_real_img.csv"),
        os.path.join(synthetic_dir, "fixed_entropy_mapping_synthetic.csv"),
        os.path.join(synthetic_dir, "dynamic_entropy_mapping_synthetic.csv")
    ]

    # folder
    current_time = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    save_dir = os.path.join("res_img", f"label_mapping_{current_time}")
