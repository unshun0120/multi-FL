...
from label_mapping.label_mapping_utils import label_mapping, evaluate_mapping_results, get_gen_images
...
class Server(BaseServer):
    ...
    def evaluate_mapping(self, current_round):
        ...
        for d_name in active_datasets:
            if d_name in self.global_gen_states:
                gen = DCGANGenerator(
                    num_classes=len(self.label_space_meta[d_name]),
        ...
        with open(csv_filename, mode='a', newline='', encoding='utf-8') as f:
            ...
            if not file_exists:
                writer.writerow(['global_round', 'entropy_ratio', 'recall', 'specificity', 'average_accuracy', 'TP', 'FP', 'TN', 'FN'])
            ...
            for thresh in dynamic_entropy_ratios:
                ...
                # [Round, Thresh, Recall, Spec, Acc, TP, FP, TN, FN]
                writer.writerow([
